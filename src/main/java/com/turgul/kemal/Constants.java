...
public class Constants {
    ...
    public static final String START_MESSAGE                     = "****************************PARSER STARTED**********************";
    public static final String SEARCH_RESULTS_MESSAGE            = "----------------SEARCH RESULTS------------------\n"; 
	...
	public static String getCommandLineUsage() {
		...
		usage.append("$ java -jar parser-jar-with-dependencies.jar com.turgul.kemal.main.Parser ");
		usage.append("[--accesslog=<pathToLogFile>] --startDate=<dateTime> --duration=(hourly | daily) --threshold=<number>\n");
		usage.append("$ java -jar parser-jar-with-dependencies.jar com.turgul.kemal.main.Parser --help\n\n");
